...
module.exports = async (ctx) => {
    ...
    if(ctx.url.endsWith('events/registration')){
        ...
        if(ctx.configuration.fusebit_events_registration &&
            ctx.configuration.fusebit_events_token){
            ...
            return {
                body: {message: 'Events API not configured', 
                status: 500 }
            };
        }
