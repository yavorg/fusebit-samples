...
exports.JobApplicationSnapshot_CertificatesRequestBuilder = void 0;
...
var JobApplicationSnapshot_CertificatesRequestBuilder = /** @class */ (function (_super) {
    ...
    JobApplicationSnapshot_CertificatesRequestBuilder.prototype.getByKey = function (backgroundElementId) {
        return new core_1.GetByKeyRequestBuilderV2(JobApplicationSnapshot_Certificates_1.JobApplicationSnapshot_Certificates, { backgroundElementId: backgroundElementId });
    };
    /**
    ...
    JobApplicationSnapshot_CertificatesRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV2(JobApplicationSnapshot_Certificates_1.JobApplicationSnapshot_Certificates);
    };
