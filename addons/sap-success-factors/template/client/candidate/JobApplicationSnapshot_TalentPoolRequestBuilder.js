...
exports.JobApplicationSnapshot_TalentPoolRequestBuilder = void 0;
...
var JobApplicationSnapshot_TalentPoolRequestBuilder = /** @class */ (function (_super) {
    ...
    JobApplicationSnapshot_TalentPoolRequestBuilder.prototype.getByKey = function (backgroundElementId) {
        return new core_1.GetByKeyRequestBuilderV2(JobApplicationSnapshot_TalentPool_1.JobApplicationSnapshot_TalentPool, { backgroundElementId: backgroundElementId });
    };
    /**
    ...
    JobApplicationSnapshot_TalentPoolRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV2(JobApplicationSnapshot_TalentPool_1.JobApplicationSnapshot_TalentPool);
    };
