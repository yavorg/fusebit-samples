...
module.exports = {
    ...
    states: {
        form: async (ctx, state, data) => {
            // Render a simple HTML form to collect configuration parameters required by the Addon. 
            ...
            // continue the Addon installation by invoking the /install endpoint on the Lifecycle Manager. 
